...
def main():
    ...
    sorted_by_user_reviews = movies.sort_values(["Reviews by Users"], ascending = False)
    ...
    print(sorted_by_user_reviews.head(20))

    # create a stacked bar graph
    #sorted_by_gross['Gross Earnings'].head(10).plot(kind="barh")
    
    #piechart
    sorted_by_user_reviews['Reviews by Users'].head(20).plot(kind="pie", title="20 highest reviewed movies")
