...
def get_ip_data():
    try:
        ...
        input_make = input("What is the Make of this machine? ")
        input_model = input("What is the Model of this machine? ")
        d = {"IP": input_ip, "driver": input_driver, "make": input_make, "model": input_model}
    except:
